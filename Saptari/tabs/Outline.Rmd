...
ggplot(data=R_pump_water_use_6.2_hr, aes(x=year, y=Yearly, fill=year)) +
  geom_bar(stat="identity")+
  geom_text(aes(label = Yearly, group = year),
            position = position_dodge(0.8),
            vjust = 1.2, size = 4.5, color = "white")+
...
SAPTARI_season_water_use_6.2_hr <- 
  gather(SAPTARI_season_water_use_6.2_hr, key="measure", value="Hours", c("Monsoon","Winter","Summer"))
...
RSB_season_water_use_6.2_hr <- 
  gather(RSB_season_water_use_6.2_hr, key="measure", value="Hours", c("Monsoon","Winter","Summer"))
