...
ggplot(lso, aes(year, Mean, color = TreatmentControl)) +
...
2018 - After 1 year - 72% increase
```{r ownland saptari mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
match.it <- matchit(own_sp ~ ownland , data = lso_M, method="nearest", ratio=3)
...
&nbsp;
after 2 year - In both groups the numbers decrease
...
ggplot(lor, aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
...
2018 - After 1 year
```{r ownland RBS mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
lor <- Land_18_19%>% 
  filter(total_land_cultivated_year>0,season=="Summer") %>%
  group_by(year,TreatmentControl, household_questionnaire_id) %>%
...
ggplot(lsc, aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  scale_x_continuous(breaks = c(2017,2018,2019))
...
ggplot(lsr, aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+scale_x_continuous(breaks = c(2018,2019))
...
2019 - After 1 year  - 74% increase
```{r  gca RBS mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
2018 - After 1 year 
```{r  Crop Intensity saptari saptari mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
2019 - After 2 year 
```{r  Crop Intensity saptari saptari mach2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
lsci <- land_17_18_19%>% filter(total_land_cultivated_year>0) %>%
  mutate(NEW_total_land_cult= case_when(TreatmentControl=="Control" & land_for_cultivation < total_land_cultivated ~ NA_real_,
                                        TRUE ~ total_land_cultivated)) %>% 
  group_by(year,TreatmentControl, household_questionnaire_id) %>%
...
2019 - After 1 year 
```{r  Crop Intensity RBS  mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
ggplot(lsi , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  scale_x_continuous(breaks = c(2017,2018,2019))
...
2019 - After 1 year - 33% increase

```{r  irrigated_out_of RBS  mach1, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
ggplot(psf, aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  scale_x_continuous(breaks = c(2017,2018,2019))
...
ggplot( wemf, aes(year, Yearly, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  scale_x_continuous(breaks = c(2017,2018,2019))
...
```{r fuel use season DiD , echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
**Matching after 1 year**
```{r fuel use season DMatching , echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
ggplot(aquas , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  scale_x_continuous(breaks = c(2017,2018,2019))
...
ggplot(raqua , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+scale_x_continuous(breaks = c(2018,2019))
```
...
ggplot(Oil , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  ggtitle("Oilseeds") +
  xlab(" ") +
...
####  Cropping Pattern:  Paddy, Wheat, Maize 
...
ggplot(pwm[7:12,] , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  ggtitle("Paddy") +
  xlab(" ") +
...
ggplot(pwm[13:18,] , aes(year, Mean, color = TreatmentControl)) +
  stat_summary(geom = 'line') +
  theme_minimal()+
  ggtitle("Wheat") +
  xlab(" ") +
