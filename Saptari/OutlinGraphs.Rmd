...
**When-**  
- divide by farmers area size _cult_area_under_crop_  

\noindent
\makebox[\linewidth]{Irrigation hours per hectare - Annually (hr)}  
...
df <- rbind(lsay,df.match) %>% select(1,2,3,6)
...
\noindent
\makebox[\linewidth]{Fuel use (L) [6.2]}
...
\noindent
\makebox[\linewidth]{Fuel use - Annually (L) [6.2]}  
...
\noindent
\makebox[\linewidth]{Fuel use - Summer (L) [6.2]}
...
\noindent
\makebox[\linewidth]{Fuel use - Winter (L) [6.2]}
...
\noindent
\makebox[\linewidth]{Fuel use - Monsoon (L) [6.2]}
...
\noindent
\makebox[\linewidth]{Cropping Pattern - Vegetables- Annual yield  (ha) }
...
\noindent
\makebox[\linewidth]{Cropping Pattern  - Oilseeds- Annual yield  (ha)}
...
\noindent
\makebox[\linewidth]{Cropping Pattern - Paddy - Annual yield (ha)}
...
\noindent
\makebox[\linewidth]{Cropping Pattern - Wheat - Annual yield (ha)}
...
\noindent
\makebox[\linewidth]{Cropping Pattern - Maize -Annual yield  (ha)}
