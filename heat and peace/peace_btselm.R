...
[1] "yearweek"                       "q3"                            
[3] "survey_date"                    "total_attacks"                 
[5] "attacks_located_IL"             "attacks_located_yesha"         
[7] "attacks_target_civilian"        "attacks_target_security_forces"
[9] "total_killed"                   "intifada"                      
[11] "week_range"                     "killed_located_IL"             
[13] "killed_located_yesha"           "killed_target_civilian"        
[15] "killed_target_security_forces"  "q1"                            
[17] "q2"                             "mean(temperature)"             
[19] "mean(humidity)"
...
write.dta(peace_btselm, "C:/Users/Dan/Documents/R/heat and peace/peace_btselm.dta")

write.table(peace_btselm, file="peace_btselm.csv",sep=",",row.names=F)
