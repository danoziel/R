...
#btselm10:  VARS 11 12 13 14- in general
...
model  <- lm(q3 ~ week0ago+week1ago + week2ago + week3ago + week4ago,data = bind11)
summary(model)
summ(model)


model  <- lm(q3 ~week0ago+week1ago + week2ago + week3ago + week4ago +
               week5ago+week6ago+week7ago+week8ago,data = bind11)
summary(model)
summ(model)

model  <- lm(q3 ~ week0ago+week1ago + week2ago + week3ago + week4ago +
               week5ago+week6ago,data = bind11)
summary(model)
summ(model)
