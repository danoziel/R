...
ses<-table(Demography_2_Baseline_2018_$b_hand_tubewell)
prop.table(ses)
ses<-table(Demography_2_Baseline_2018_$borewell)
prop.table(ses)
table(Demography_2_Baseline_2018_$treadle_pump)

ses<-table(Demography_2_Baseline_2018_$electric_pump)
prop.table(ses)
ses<-table(Demography_2_Baseline_2018_$diesel_pump)
prop.table(ses)
